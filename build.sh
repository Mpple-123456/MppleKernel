...
compile() {
    echo "编译内核..."
    check_cmd "$GXX"
    CFLAGS="-m32 -ffreestanding -nostdlib -fno-builtin -fno-exceptions -fno-rtti -O2 -c kernel.cpp -o kernel.o -std=c++11"
...
link() {
    echo "链接内核..."
    check_cmd "$LD"
    $LD -m elf_i386 -T linker.ld -o "$KERNEL_ELF" kernel.o
    echo "完成: $KERNEL_ELF"
}
